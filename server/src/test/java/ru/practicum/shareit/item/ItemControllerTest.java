...
public class ItemControllerTest {
    ...
    @Test
    void addItemReturnItemDto() throws Exception {
    ...
    @Test
    void updateItemReturnUpdatedItemDto() throws Exception {
    ...
    @Test
    void getItemByIdReturnItemDto() throws Exception {
    ...
    @Test
    void getAllItemsReturnListOfItems() throws Exception {
    ...
    @Test
    void findItemsReturnListOfItems() throws Exception {
        List<ItemDto> items = List.of(itemDto);
    ...
    @Test
    void addCommentReturnCommentDtoExport() throws Exception {

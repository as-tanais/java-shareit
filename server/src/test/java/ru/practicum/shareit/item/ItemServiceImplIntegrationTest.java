...
public class ItemServiceImplIntegrationTest {
    ...
    @Test
    void getAllUserItemsReturnAllItemsForUser() {
    ...
    @Test
    void findItemsReturnItemsContainingText() {
    ...
    @Test
    void findItemsReturnEmptyListWhenNoMatches() {

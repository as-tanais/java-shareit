...
public class ItemRequestControllerTest {
    ...
    @Test
    void addRequestReturnCreatedRequest() throws Exception {
    ...
    @Test
    void getByUserIdReturnRequestList() throws Exception {
    ...
    @Test
    void getAllRequestsReturnAllRequests() throws Exception {
        List<ItemRequestDto> requests = List.of(itemRequestDto);
    ...
    @Test
    void getRequestByIdReturnRequest() throws Exception {

...
public class BookingServiceImplTest {
    ...
    @Test
    void createBookingItemUnavailableThrowException() {
    ...
    @Test
    void createBookingUserNotFoundThrowException() {
    ...
    @Test
    void approveBookingReturnApprovedBookingDto() {
    ...
    @Test
    void approveBookingNotOwnerThrowAccessException() {
        when(bookingRepository.existsById(1)).thenReturn(true);
        when(bookingRepository.findById(anyInt())).thenReturn(Optional.of(booking));
    ...
    @Test
    void approveBookingNotExistThrowNotFoundException() {
    ...
    @Test
    void getBookingUserIsBookerReturnBookingDto() {
        when(bookingRepository.findById(anyInt())).thenReturn(Optional.of(booking));
    ...
    @Test
    void getAllBookingsStateIsAll() {
        when(bookingRepository.findAllByBookerId(anyInt())).thenReturn(List.of(booking));
        doNothing().when(userService).validateUserById(anyInt());

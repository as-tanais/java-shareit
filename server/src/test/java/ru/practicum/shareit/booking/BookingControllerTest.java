...
public class BookingControllerTest {
    ...
    @Test
    void createBookingReturnStatusOk() throws Exception {
    ...
    @Test
    void approveBookingReturnApprovedStatus() throws Exception {
    ...
    @Test
    void approveBookingReturnAccessDenied() throws Exception {
        int bookingId = 1;
        boolean approved = true;
        int userId = 2;
    ...
    @Test
    void getBookingReturnBookingDetails() throws Exception {
        int bookingId = 1;
        int userId = 1;
    ...
    @Test
    void getBookingReturnAccessDenied() throws Exception {
        int bookingId = 1;
    ...
    @Test
    void getAllBookingsReturnBookingList() throws Exception {
        int userId = 1;
    ...
    @Test
    void getAllByOwnerReturnStatusOkWithAllState() throws Exception {
        List<BookingDto> bookings = List.of(bookingDtoResponse);
